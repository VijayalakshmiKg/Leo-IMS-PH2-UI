...
//       apiKey: 'AIzaSyAHeOi92-OK9g-OGYI6d4mtZOFsdUIxf1M', // Replace with your actual API key
//       version: 'weekly',
//     });
...
//           icon: {
//             url: `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(location.svg)}`, // Convert SVG to data URL
...
//     });
  ...
  getTrackingVehiclesByStatus(status?: any | string) {
    ...
    /*
    const loader = new Loader({
      apiKey: 'AIzaSyBwQzyeg_ljUCYV2YDbZ_KBgmDTrKoiKSc', // Replace with your actual API key
      version: 'weekly',
    });
